...
export default function Input() {
    ...
    return (
        <div className="d-flex align-items-center" style={{ width: "100%", minHeight: "70px", backgroundColor: "#ebedf0", margin: "20px 0", padding: "10px", borderRadius: "14px", paddingTop: '15px' }}>
            <div style={{ width: "100%" }}>
